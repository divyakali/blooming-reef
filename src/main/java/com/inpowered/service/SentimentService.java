...
public class SentimentService {
	...
	public BloomingReefSentiment getSentiment(String url){
		...
		BloomingReefSentiment sentiment =  repo.findOneByUrl(url);
		if(sentiment==null){
	...
	public BloomingReefSentiment analyze(SentimentRequest request) throws TextAPIException{
		...
		BloomingReefSentiment sentiment = new BloomingReefSentiment(client.sentiment(builder.build()));
